...
describe('Service Tests', () => {
    ...
    describe('MascotaMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(MascotaMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/mascotas';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return MascotaMySuffix', () => {
