...
describe('Service Tests', () => {
    ...
    describe('PersonaMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(PersonaMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/personas';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return PersonaMySuffix', () => {
