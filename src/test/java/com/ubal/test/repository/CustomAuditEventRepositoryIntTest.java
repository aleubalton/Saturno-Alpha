...
import com.ubal.test.config.audit.AuditEventConverter;
import com.ubal.test.domain.PersistentAuditEvent;
...
import static com.ubal.test.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
