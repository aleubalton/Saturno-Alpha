...
public class AgendaResourceIntTest {
    ...
    private static final Integer DEFAULT_DURACION_EVENTO = 1;
    private static final Integer UPDATED_DURACION_EVENTO = 2;
    ...
    public static Agenda createEntity(EntityManager em) {
        Agenda agenda = new Agenda()
            ...
            .duracionEvento(DEFAULT_DURACION_EVENTO)
            .estado(DEFAULT_ESTADO);
        // Add required entity
        Intervalo intervalo = IntervaloResourceIntTest.createEntity(em);
        em.persist(intervalo);
        em.flush();
        agenda.getIntervalos().add(intervalo);
        // Add required entity
        DiaNoLaborable diaNoLaborable = DiaNoLaborableResourceIntTest.createEntity(em);
        em.persist(diaNoLaborable);
        em.flush();
        agenda.getDiaNoLaborables().add(diaNoLaborable);
        // Add required entity
    ...
    public void createAgenda() throws Exception {
        ...
        assertThat(testAgenda.getTipoDeRecurso()).isEqualTo(DEFAULT_TIPO_DE_RECURSO);
        ...
        assertThat(testAgenda.getDuracionEvento()).isEqualTo(DEFAULT_DURACION_EVENTO);
        assertThat(testAgenda.getEstado()).isEqualTo(DEFAULT_ESTADO);
    }
    ...
    @Test
    @Transactional
    public void checkTipoDeRecursoIsRequired() throws Exception {
        int databaseSizeBeforeTest = agendaRepository.findAll().size();
        // set the field null
        agenda.setTipoDeRecurso(null);
    ...
    public void getAllAgenda() throws Exception {
        ...
        restAgendaMockMvc.perform(get("/api/agenda?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].duracionEvento").value(hasItem(DEFAULT_DURACION_EVENTO)))
    ...
    public void getAgenda() throws Exception {
        ...
        restAgendaMockMvc.perform(get("/api/agenda/{id}", agenda.getId()))
            ...
            .andExpect(jsonPath("$.duracionEvento").value(DEFAULT_DURACION_EVENTO))
    ...
    public void updateAgenda() throws Exception {
        ...
        updatedAgenda
            ...
            .duracionEvento(UPDATED_DURACION_EVENTO)
        ...
        assertThat(testAgenda.getTipoDeRecurso()).isEqualTo(UPDATED_TIPO_DE_RECURSO);
        ...
        assertThat(testAgenda.getDuracionEvento()).isEqualTo(UPDATED_DURACION_EVENTO);
        assertThat(testAgenda.getEstado()).isEqualTo(UPDATED_ESTADO);
    }
