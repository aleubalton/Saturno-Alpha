...
public class ServicioResourceIntTest {
    ...
    public static Servicio createEntity(EntityManager em) {
        ...
        // Add required entity
        TipoDeServicio tipo = TipoDeServicioResourceIntTest.createEntity(em);
        em.persist(tipo);
        em.flush();
    ...
    public void createServicio() throws Exception {
        ...
        assertThat(testServicio.getPrecio()).isEqualTo(DEFAULT_PRECIO);
    ...
    public void updateServicio() throws Exception {
        ...
        assertThat(testServicio.getPrecio()).isEqualTo(UPDATED_PRECIO);
