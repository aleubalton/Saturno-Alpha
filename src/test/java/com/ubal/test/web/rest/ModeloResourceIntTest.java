...
public class ModeloResourceIntTest {
    ...
    private static final Integer DEFAULT_ANIOFIN_PRODUCCION = 1950;
    private static final Integer UPDATED_ANIOFIN_PRODUCCION = 1951;
    ...
    public static Modelo createEntity(EntityManager em) {
        Modelo modelo = new Modelo()
            ...
            .aniofinProduccion(DEFAULT_ANIOFIN_PRODUCCION);
        // Add required entity
    ...
    public void createModelo() throws Exception {
        ...
        assertThat(testModelo.getCategoria()).isEqualTo(DEFAULT_CATEGORIA);
        assertThat(testModelo.getAnioInicioProduccion()).isEqualTo(DEFAULT_ANIO_INICIO_PRODUCCION);
        assertThat(testModelo.getAniofinProduccion()).isEqualTo(DEFAULT_ANIOFIN_PRODUCCION);
    }
    ...
    public void getAllModelos() throws Exception {
        ...
        restModeloMockMvc.perform(get("/api/modelos?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].aniofinProduccion").value(hasItem(DEFAULT_ANIOFIN_PRODUCCION)));
    }
    ...
    public void getModelo() throws Exception {
        ...
        restModeloMockMvc.perform(get("/api/modelos/{id}", modelo.getId()))
            ...
            .andExpect(jsonPath("$.aniofinProduccion").value(DEFAULT_ANIOFIN_PRODUCCION));
    }
    ...
    public void updateModelo() throws Exception {
        ...
        updatedModelo
            ...
            .aniofinProduccion(UPDATED_ANIOFIN_PRODUCCION);
        ...
        assertThat(testModelo.getCategoria()).isEqualTo(UPDATED_CATEGORIA);
        assertThat(testModelo.getAnioInicioProduccion()).isEqualTo(UPDATED_ANIO_INICIO_PRODUCCION);
        assertThat(testModelo.getAniofinProduccion()).isEqualTo(UPDATED_ANIOFIN_PRODUCCION);
    }
