...
public class DiaNoLaborableResource {
    ...
    @Timed
    public ResponseEntity<DiaNoLaborableDTO> createDiaNoLaborable(@RequestBody DiaNoLaborableDTO diaNoLaborableDTO) throws URISyntaxException {
    ...
    @Timed
    public ResponseEntity<DiaNoLaborableDTO> updateDiaNoLaborable(@RequestBody DiaNoLaborableDTO diaNoLaborableDTO) throws URISyntaxException {
        log.debug("REST request to update DiaNoLaborable : {}", diaNoLaborableDTO);
        if (diaNoLaborableDTO.getId() == null) {
            return createDiaNoLaborable(diaNoLaborableDTO);
        }
        DiaNoLaborableDTO result = diaNoLaborableService.save(diaNoLaborableDTO);
    ...
    public ResponseEntity<DiaNoLaborableDTO> getDiaNoLaborable(@PathVariable Long id) {
        ...
        DiaNoLaborableDTO diaNoLaborableDTO = diaNoLaborableService.findOne(id);
        return ResponseUtil.wrapOrNotFound(Optional.ofNullable(diaNoLaborableDTO));
    }
